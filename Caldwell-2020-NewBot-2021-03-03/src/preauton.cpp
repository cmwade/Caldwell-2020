...
void pre_auton( void ) {
  ...
  // Runs the autonomous selection tasks.
  ...
  if (alliance==RED) {Brain.Screen.printAt(1, 20, "Alliance: Red"); con.Screen.setCursor(3,1); con.Screen.print("R");}
  else if (alliance==BLUE) {Brain.Screen.printAt(1,20,"Alliance: Blue"); con.Screen.setCursor(3,1); con.Screen.print("B");}
  else {Brain.Screen.printAt(1,20,"Alliance: Skills"); con.Screen.setCursor(3,1); con.Screen.print("S");}

  if (side==LEFT) {Brain.Screen.printAt(1,40,"Side: Left"); con.Screen.setCursor(3,2); con.Screen.print("L");}
  else {Brain.Screen.printAt(1,40,"Side: Right"); con.Screen.setCursor(3,2); con.Screen.print("R");}

  if (mode==SIMPLE) {Brain.Screen.printAt(1,60,"Mode: Simple"); con.Screen.setCursor(3,3); con.Screen.print("S");}
  else if (mode==COMPLEX) {Brain.Screen.printAt(1,60,"Mode: Complex"); con.Screen.setCursor(3,3); con.Screen.print("C");}
  else {Brain.Screen.printAt(1, 60, "Mode: Home Row"); con.Screen.setCursor(3,3); con.Screen.print("Hr");}
